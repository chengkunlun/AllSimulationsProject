...
NSString *const NewCellIndentifier = @"JokeCell";
...
-(void)addMyTableView{
    ...
    [self.tableView registerClass:[JokeCell class] forCellReuseIdentifier:NewCellIndentifier];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    JokeCell *cell = (JokeCell *)[tableView dequeueReusableCellWithIdentifier:NewCellIndentifier];
